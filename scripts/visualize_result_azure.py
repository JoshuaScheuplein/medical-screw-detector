...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_dir', type=str, default="", help='Directory containing the input images')
    parser.add_argument('--prediction_dir', type=str, default="", help='Directory containing the predictions')
