...
def get_helper_parser():
    ...
    parser = argparse.ArgumentParser('Helper main script for screw detection evaluation', add_help=False)
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser('Helper main script for screw detection evaluation', parents=[get_helper_parser()])
    ...
    command = f"python models/main_azure_test_metrics.py --azure"
